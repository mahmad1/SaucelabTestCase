...
public class DemoMiracle implements SauceOnDemandSessionIdProvider {

	public String username = "Kheerthi";
	public String accesskey = "6e22bfc2-a817-4f75-8209-b531643f777b";							   
	...
	public void CPTK_1000_spl100_New_flow() throws Exception {
			...
			driver.get("http://test-seleniummss.mybluemix.net/");
			String textfromid = driver.findElement(By.id("message")).getText();
			if(textfromid.endsWith("Hello World!testgjhjkj"))
			{
